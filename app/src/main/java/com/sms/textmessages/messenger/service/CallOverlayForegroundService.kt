...
// Short-lived foreground service that runs ONLY while the call overlay window
// is visible. Keeps process priority during the call without a permanent
// keep-alive. Started after addView; stopped on overlay dismiss.
